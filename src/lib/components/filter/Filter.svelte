	...
	{#if search}
		<div class="flex flex-col px-4 lg:px-16 w-full md:max-w-2xl relative h-11 mb-4">
			...
			<Icon
				...
				class="absolute h-7 w-7 left-6 lg:left-[4.5rem] top-2 rounded-sm dark:text-neutral-400 text-neutral-600"
			/>
			<button
				class="absolute h-7 w-7 right-6 lg:right-[4.5rem] top-2 rounded-sm dark:text-neutral-400 text-neutral-600"
