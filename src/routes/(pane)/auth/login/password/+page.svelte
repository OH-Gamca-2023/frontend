...
<form
	class="flex flex-col gap-2 mt-2 pb-4 mb-4 border-b border-neutral-200 dark:border-neutral-600"
...
>
	<label class="flex flex-col gap-1">
		<span class="text-neutral-800 dark:text-neutral-100">Prihlasovacie meno alebo e-mail</span>
		<input
			bind:value={loginFieldValue}
			type="text"
			class="rounded-lg font-bold px-4 py-2 bg-neutral-200 dark:bg-zinc-800 disabled:bg-neutral-400 disabled:dark:bg-neutral-500
	...
	<label class="flex flex-col gap-1">
		<span class="text-neutral-800 dark:text-neutral-100">Heslo</span>
		<input
